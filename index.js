...
let randomnum = [];
randomnum[0] = numbers[Math.floor(Math.random() * 4)][Math.floor(Math.random() * 6)];
randomnum[1] = numbers[Math.floor(Math.random() * 4)][Math.floor(Math.random() * 6)];
randomnum[2] = numbers[Math.floor(Math.random() * 4)][Math.floor(Math.random() * 6)];
